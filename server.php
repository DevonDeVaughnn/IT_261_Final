...
if (isset($_POST['reg_user'])) {
    ...
    if (count($errors) < 1) {
        //introduce new function md5()- this function spits out in your db a 32 hex char value for password
        $password = md5($password_1);
        //we must insert our registration data into the table inside our db,
        //and this will happen by using the INSERT
